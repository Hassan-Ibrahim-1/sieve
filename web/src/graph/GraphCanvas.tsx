...
export function GraphCanvas(props: Props) {
  const drawLabel = createNodeLabelRenderer(props.theme);
  return <div className="graph-canvas" tabIndex={0} aria-label="Interactive mathematical graph"
    ...
    <SigmaContainer settings={{
      ...
      labelSize: 10,
      labelWeight: "500",
      labelColor: { color: props.theme === "dark" ? "#e9efeb" : "#18211e" },
      labelDensity: 0.55,
...
function createNodeLabelRenderer(theme: Theme): NodeLabelDrawingFunction {
  return (context, data, settings) => {
    ...
    context.fillStyle = theme === "dark" ? "rgba(17, 21, 19, .94)" : "rgba(255, 255, 255, .96)";
    context.fill();
    context.strokeStyle = theme === "dark" ? "rgba(66, 199, 147, .24)" : "rgba(24, 33, 30, .15)";
    context.lineWidth = 1;
    context.stroke();

    context.fillStyle = theme === "dark" ? "#e9efeb" : "#18211e";
